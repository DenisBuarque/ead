...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.discipline.show',['id' => $discipline->id ]) }}" class="btn btn-md btn-info" title="Voltar aos módulos da disciplina">
...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.module.store.file') }}" enctype="multipart/form-data" autocomplete="off">
            @csrf
            <input type="hidden" name="discipline_id" value="{{ $discipline->id }}" />
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de arquivo <strong>{{ $discipline->title }}</strong></h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control  @error('description') is-invalid @enderror" required style="width: 100%;" placeholder="Digite uma breve descrição sobre o arquivo.">{{ old('description') }}</textarea>
                                @error('description')
