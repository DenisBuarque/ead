...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.discipline.show', ['id' => $module->discipline_id]) }}" class="btn btn-md btn-info"
        ...
        <form method="POST" action="{{ route('admin.module.update',['id' => $module->id]) }}" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de edição de dados do vídeo
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group m-0">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="movie" value="{{ $module->movie ?? old('movie') }}" placeholder="Ex: oy4cbqE1_qc"
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                ...
                                <textarea name="description" class="form-control  @error('description') is-invalid @enderror" required
                                    style="width: 100%;">{{ $module->description ?? old('description') }}</textarea>
                                @error('description')
