...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.teachers.index') }}" class="btn btn-md btn-info" title="Listar registros cadastrados">
...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.teacher.store') }}" onsubmit="return mySubmit()"
            enctype="multipart/form-data" autocomplete="off">
            @csrf
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário cadastro de dados do professor:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group m-0">
                                ...
                                <select name="access" id="institution" class="form-control">
