...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.openquestion.store') }}" autocomplete="off" onsubmit="return mySubmit()">
            @csrf
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-0">
                                <small>Título da pergunta:</small>
                                <textarea name="title" class="form-control @error('title') is-invalid @enderror" style="width: 100%;"
                                    placeholder="Descreva aqui a pergunta da questão.">{{ old('title') }}</textarea>
                                @error('title')
