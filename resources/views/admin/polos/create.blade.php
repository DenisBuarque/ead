...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.polo.store') }}" onsubmit="return mySubmit()" autocomplete="off">
            @csrf
            <div class="card card-info" style="max-width: 1024px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário cadastro de dados polo de ensino:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-0">
                                ...
                                <input type="text" name="address" id="address" value="{{ old('address') }}"
                                    maxlength="250" class="form-control l @error('address') is-invalid @enderror"/>
                                @error('address')
                                    <small class="text-red line-height">{{ $message }}</small>
                                @enderror
                            </div>
