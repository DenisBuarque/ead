...
<div class="container-fluid">
    <form method="POST" action="{{route('dashboard.student.update',['id' => $student->id])}}" onsubmit="return mySubmit()" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="card card-info" style="max-width: 1024px; margin: auto">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group m-0">
                            <small>Senha:</small>
                            <input type="password" name="password" value="{{ old('password') }}" maxlength="30" class="form-control @error('password') is-invalid @enderror" placeholder="******"/>
                            @error('password')
                                <small class="text-red line-height">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="card-footer">
                <a href="{{ route('dashboard') }}" type="submit" class="btn btn-default">Cancelar</a>
